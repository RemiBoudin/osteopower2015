...
public class UserHelper
{
     ...
     * @param t User value
     */
    public static void insert(org.omg.CORBA.Any a, user.User t)
    {
     ...
     */
    public static user.User extract(org.omg.CORBA.Any a)
    {
        if (!a.type().equal(type()))
            throw new org.omg.CORBA.MARSHAL();
        try {
            return user.UserHelper.narrow(a.extract_Object());
     ...
     */
    public static user.User read(org.omg.CORBA.portable.InputStream istream)
    {
        return(user.User)istream.read_Object(user._UserStub.class);
    }
     ...
     */
    public static void write(org.omg.CORBA.portable.OutputStream ostream, user.User value)
    {

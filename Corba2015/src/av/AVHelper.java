...
public class AVHelper
{
     ...
     * @param t AV value
     */
    public static void insert(org.omg.CORBA.Any a, av.AV t)
    {
     ...
     */
    public static av.AV extract(org.omg.CORBA.Any a)
    {
        if (!a.type().equal(type()))
            throw new org.omg.CORBA.MARSHAL();
        try {
            return av.AVHelper.narrow(a.extract_Object());
     ...
     */
    public static av.AV read(org.omg.CORBA.portable.InputStream istream)
    {
        return(av.AV)istream.read_Object(av._AVStub.class);
    }
     ...
     */
    public static void write(org.omg.CORBA.portable.OutputStream ostream, av.AV value)
    {

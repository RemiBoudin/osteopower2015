...
public class CertificatHelper
{
     ...
     */
    public static void insert(org.omg.CORBA.Any a, certificat.Certificat t)
    {
        a.insert_Streamable(new certificat.CertificatHolder(t));
    }
     ...
     */
    public static certificat.Certificat extract(org.omg.CORBA.Any a)
    {
        ...
        if (HAS_OPENORB && a instanceof org.openorb.CORBA.Any) {
            ...
            try {
                ...
                if(s instanceof certificat.CertificatHolder)
                    return ((certificat.CertificatHolder)s).value;
            } catch (org.omg.CORBA.BAD_INV_ORDER ex) {
            }
            certificat.CertificatHolder h = new certificat.CertificatHolder(read(a.create_input_stream()));
     ...
     */
    public static certificat.Certificat read(org.omg.CORBA.portable.InputStream istream)
    {
        certificat.Certificat new_one = new certificat.Certificat();
     ...
     */
    public static void write(org.omg.CORBA.portable.OutputStream ostream, certificat.Certificat value)
    {

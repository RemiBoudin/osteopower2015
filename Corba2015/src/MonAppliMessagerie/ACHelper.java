...
public class ACHelper
{
     ...
     * @param t AC value
     */
    public static void insert(org.omg.CORBA.Any a, MonAppliMessagerie.AC t)
    {
    ...
    public static MonAppliMessagerie.AC extract(org.omg.CORBA.Any a)
    {
        ...
        try {
            return MonAppliMessagerie.ACHelper.narrow(a.extract_Object());
    ...
    {
        return(MonAppliMessagerie.AC)istream.read_Object(MonAppliMessagerie._ACStub.class);
    }

...
public class certif_revoqueHelper
{
     ...
     */
    public static void insert(org.omg.CORBA.Any a, MonAppliMessagerie.certif_revoque t)
    {
        a.insert_Streamable(new MonAppliMessagerie.certif_revoqueHolder(t));
    }
    ...
    public static MonAppliMessagerie.certif_revoque extract(org.omg.CORBA.Any a)
    {
        ...
        if (HAS_OPENORB && a instanceof org.openorb.CORBA.Any) {
            ...
            try {
                ...
                if(s instanceof MonAppliMessagerie.certif_revoqueHolder)
                    return ((MonAppliMessagerie.certif_revoqueHolder)s).value;
            } catch (org.omg.CORBA.BAD_INV_ORDER ex) {
            }
            MonAppliMessagerie.certif_revoqueHolder h = new MonAppliMessagerie.certif_revoqueHolder(read(a.create_input_stream()));
    ...
    {
        MonAppliMessagerie.certif_revoque new_one = new MonAppliMessagerie.certif_revoque();

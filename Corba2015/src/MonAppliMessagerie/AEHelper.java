...
public class AEHelper
{
     ...
     * @param t AE value
     */
    public static void insert(org.omg.CORBA.Any a, MonAppliMessagerie.AE t)
    {
    ...
    public static MonAppliMessagerie.AE extract(org.omg.CORBA.Any a)
    {
        ...
        try {
            return MonAppliMessagerie.AEHelper.narrow(a.extract_Object());
    ...
    {
        return(MonAppliMessagerie.AE)istream.read_Object(MonAppliMessagerie._AEStub.class);
    }

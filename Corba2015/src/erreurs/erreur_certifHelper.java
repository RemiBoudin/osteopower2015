...
public class erreur_certifHelper
{
     ...
     */
    public static void insert(org.omg.CORBA.Any a, erreurs.erreur_certif t)
    {
        a.insert_Streamable(new erreurs.erreur_certifHolder(t));
    }
     ...
     */
    public static erreurs.erreur_certif extract(org.omg.CORBA.Any a)
    {
        ...
        if (HAS_OPENORB && a instanceof org.openorb.CORBA.Any) {
            ...
            try {
                ...
                if(s instanceof erreurs.erreur_certifHolder)
                    return ((erreurs.erreur_certifHolder)s).value;
            } catch (org.omg.CORBA.BAD_INV_ORDER ex) {
            }
            erreurs.erreur_certifHolder h = new erreurs.erreur_certifHolder(read(a.create_input_stream()));
     ...
     */
    public static erreurs.erreur_certif read(org.omg.CORBA.portable.InputStream istream)
    {
        erreurs.erreur_certif new_one = new erreurs.erreur_certif();
     ...
     */
    public static void write(org.omg.CORBA.portable.OutputStream ostream, erreurs.erreur_certif value)
    {

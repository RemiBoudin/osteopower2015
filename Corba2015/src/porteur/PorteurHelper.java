...
public class PorteurHelper
{
     ...
     */
    public static void insert(org.omg.CORBA.Any a, porteur.Porteur t)
    {
     ...
     */
    public static porteur.Porteur extract(org.omg.CORBA.Any a)
    {
        if (!a.type().equal(type()))
            throw new org.omg.CORBA.MARSHAL();
        try {
            return porteur.PorteurHelper.narrow(a.extract_Object());
     ...
     */
    public static porteur.Porteur read(org.omg.CORBA.portable.InputStream istream)
    {
        return(porteur.Porteur)istream.read_Object(porteur._PorteurStub.class);
    }
     ...
     */
    public static void write(org.omg.CORBA.portable.OutputStream ostream, porteur.Porteur value)
    {
